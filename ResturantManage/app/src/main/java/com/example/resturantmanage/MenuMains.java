...
public class MenuMains extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView =(RecyclerView) findViewById(R.id.mainsList);
        ...
        materialSearchBar =(MaterialSearchBar)findViewById(R.id.searchBarMains);
    ...
    public  boolean onOptionsItemSelected(MenuItem item){
        ...
        if(id == R.id.action_basket) {
            Intent intent = new Intent(MenuMains.this, com.example.resturantmanage.OrderCart.class);
            ...
            protected void populateViewHolder(FoodViewHolder foodViewHolder, Food food, int i) {
                ...
                foodViewHolder.setItemClickListener(new ItemClickListener() {
                    ...
                    public void onClick(View view, int position, boolean isLongClick) {
                        Toast.makeText(MenuMains.this,""+local.getName(),Toast.LENGTH_SHORT).show();
                        Intent foodDetail = new Intent(MenuMains.this,FoodDetail.class);
