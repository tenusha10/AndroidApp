...
public class MenuStarters extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        materialSearchBar =(MaterialSearchBar)findViewById(R.id.searchBarStarters);
            ...
            protected void populateViewHolder(FoodViewHolder foodViewHolder, Food food, int i) {
                ...
                foodViewHolder.setItemClickListener(new ItemClickListener() {
                    ...
                    public void onClick(View view, int position, boolean isLongClick) {
                        Toast.makeText(MenuStarters.this,""+local.getName(),Toast.LENGTH_SHORT).show();
                        Intent foodDetail = new Intent(MenuStarters.this,FoodDetail.class);
    ...
    public  boolean onOptionsItemSelected(MenuItem item){
        ...
        if(id == R.id.action_basket) {
            Intent intent = new Intent(MenuStarters.this, com.example.resturantmanage.OrderCart.class);
